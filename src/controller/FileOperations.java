...
public class FileOperations {
    ...
    public FileOperations(SIGFrame frame) {
        this.frame = frame;
    }
    
    public void loadFiles() throws Exception {
        frame.getFilesData().clear();
        JOptionPane.showMessageDialog(frame, "Please select the Invoice header file(.CSV)", "Invoice Header", JOptionPane.INFORMATION_MESSAGE);
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          //  try {
            ...
            JOptionPane.showMessageDialog(frame, "Please select the Invoice lines file (.CSV)", "Invoice Lines", JOptionPane.INFORMATION_MESSAGE);
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                headerBr.close();
                headerFr.close();
                frame.setHeaderTableModel(new InvoiceHeaderTableModel(frame.getFilesData()));
    ...
    public void saveData()  {
        ...
        if (file != null && state == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "There is a Failure");
            }
        }
